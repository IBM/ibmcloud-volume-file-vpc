...
func TestListSubnets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			content:   "{\"errors\":[{\"message\":\"testerr\",\"Code\":\"subnet_list_not_found\"}], \"trace\":\"2af63776-4df7-4970-b52d-4e25676ec0e4\"}",
			expectErr: "Trace Code:2af63776-4df7-4970-b52d-4e25676ec0e4, Code:subnet_list_not_found, Description:testerr, RC:404 Not Found",
		}, {
